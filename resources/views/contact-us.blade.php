                    ...
                    <div class="col-md-4 ms-auto order-2" data-aos="fade-up">
                        <ul class="list-unstyled">
                            <li class="mb-3">
                                ...
                                <span>Matice Slovenskej 4, Presov, Slovakia</span>
                            </li>
                            <li class="mb-3">
                                <strong class="d-block mb-1">Phone</strong>
                                <span>+421 907 112 358</span>
                            </li>
                            <li class="mb-3">
                                <strong class="d-block mb-1">Email</strong>
                                <span>info@countries.app</span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <form wire:submit.prevent="submitForm" class="php-email-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mt-3">
                                    ...
                                    <textarea wire:model="message" class="form-control" id="message" required></textarea>
                                </div>
